...
urlpatterns = [
    ...
    path('products/last/', views.ProductLastListView.as_view(), name='product'), 
    ...
    path('movements/last/', views.MovementLastListView.as_view(), name='product'), 
    ...
    path('operations/last/', views.OperationLastListView.as_view(), name='product'), 
]
